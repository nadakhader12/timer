    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseworks" class="collapse" aria-labelledby="headingworks"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">

                        <a class="collapse-item" href="{{ route('admin.works.index') }}">All Works </a>
                        <a class="collapse-item" href="{{ route('admin.works.create') }}">Add new </a>
                        <a class="collapse-item" href="{{ route('admin.works.trash') }}">tashed </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseoffers" class="collapse" aria-labelledby="headingoffers"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">

                        <a class="collapse-item" href="{{ route('admin.offers.index') }}">All offers </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseservices" class="collapse" aria-labelledby="headingservices"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('admin.features.index') }}">All services </a>
